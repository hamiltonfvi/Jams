...
public class DanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Song("Tonight (I'm Lovin' You)", "Enrique Iglesias & Ludacris", R.drawable.dance15, R.raw.dance15));
        ...
        songs.add(new Song("The Fox (What Does The Fox Say)", "Ylvis", R.drawable.dance19, R.raw.dance19));
