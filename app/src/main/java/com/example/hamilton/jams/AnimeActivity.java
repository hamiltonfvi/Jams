...
public class AnimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Song("Teenage Mutant Ninja Turtles Theme", "Teenage Mutant Ninja Turtles", R.drawable.anime01, R.raw.anime01));
        ...
        songs.add(new Song("Looney Toones Theme", "Looney Toones", R.drawable.anime10, R.raw.anime10));
        ...
        songs.add(new Song("Powerpuff Girls Theme", "Powerpuff Girls", R.drawable.anime15, R.raw.anime15));
